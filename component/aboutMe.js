    ...
    <section id="about" className='container mx-auto px-4 sm:px-6 md:px-10 lg:px-15 xl:px-20 py-8 sm:py-12 md:py-16 lg:py-20'>
      ...
      <div className='shadow-2xl rounded-2xl pb-6 sm:pb-8 md:pb-10'>
        <p className='text-justify font-[poppins] px-4 sm:px-8 md:px-12 lg:px-16 xl:px-28 text-base sm:text-lg md:text-xl lg:text-2xl py-4 sm:py-6 md:py-8'>
          ...
          <br></br>
          <br></br>
          In addition to my professional stack, I have experience with <u><i>React</i></u>, <u><i>Next.js</i></u>, <u><i>Node.js</i></u>, <u><i>Express.js,</i></u>, <u><i>MongoDB</i></u>, <u><i>Socket.IO</i></u> and <u><i>Redis</i></u>, which allows me to contribute across the full software development lifecycle. With a background in blockchain research and a strong focus on clean architecture and problem-solving, I am passionate about building secure, efficient and user-centered software solutions.
          <br></br>
          <br></br>
